  ...
  return (
    <MotionComponent
      className={cn(
        ...
        '[--base-color:hsl(var(--muted-foreground)/0.3)] [--base-gradient-color:hsl(var(--primary))]',
        'dark:[--base-color:hsl(var(--muted-foreground)/0.3)] dark:[--base-gradient-color:hsl(var(--accent))]',
        className
      )}
